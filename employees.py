...
class Employee:
    ...
    def __repr__(self):
        return "<Emloyee: name=%s, salary=%s>" % (self.name, self.salary)
...
if __name__ == "__main__":
    ...
    print (bob)             # Выолняется унаследованный метод __repr__
    bob.work()              # Выполняется действие, специфичное для типа
    bob.giveRaise(0.20)     # Повысит зарплату роботу bob на 20%
    print(bob); print()
